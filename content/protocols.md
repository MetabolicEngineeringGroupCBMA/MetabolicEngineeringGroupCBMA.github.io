...
Colony PCR from yeast is a notoriously fickle protocol which can be seen by the many protocol variations available online.
It seems many users have to tweak their protocols for them to work. The protocols below are listed in order of difficulty.
Test the protocol with a positive and negative control if you can.
