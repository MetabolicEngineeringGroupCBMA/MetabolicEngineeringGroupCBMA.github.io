...
![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_001.png]]

Search Entrez for the accession number **AJ937350** as shown below.

![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_002.png]]
...
![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_003.png]]
...
![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_005.png]]
...
![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_006.png]]
...
![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_001-1.png]]
...
For some large genbank files, the sequence is initially **hidden** due to its large size. The file with the accession number **NC\_001133** describe the _Saccharomyces cerevisiae_ S288C chromosome I that is the smallest of the sixteen chromosomes of this organism, but still over 200 000 bp (below).

![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_007.png]]
...
![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_008.png]]

Scroll down to the end of the page and you will be able to see the sequence for the FUN48 gene (below).

![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_010.png]]
...
The gene <a name="feature_nc_001133.9_gene_16"></a>ACS1 is located on the same chromosome as the FUN48 gene, but on the **complement** strand to the one in the database between position 42881 and 45022.
Change the start and the stop positions and
Click on “show reverse complement” and then “Update View” (Fig 11) to show the gene in the correct order where the first three nucleotides are the start codon.

![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_011.png]]

The resulting sequence should be similar to the one below:

![[TPs/TP06_How_to_download_sequences_from_Genbank/TP06_012.png]]
