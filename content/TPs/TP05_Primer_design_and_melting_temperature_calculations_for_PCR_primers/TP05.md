...
In [[TPs/TP04_Manual PCR simulation/TP04|TP04]] we learned how to design primers given a template sequence. This exercise will show you how to design PCR primers that can work well in a real PCR.
...
```
     ...
     |                                   |
95C  | 95C                               |
_____|____________              72C      | 72C
4min | 30s        \         _____________|_______
     |             \  50C  / 1min30s     | 4min
     |              \_____/              |
     |               30s                 |
```
...
Where A, T, G and C  are the number of the respective bases in the sequence (modified from Marmur, J., and Doty, P. 1962 _J Mol Biol_ **5**:109-118). According to this formula, the Tm for the primer below is 38ºC:
