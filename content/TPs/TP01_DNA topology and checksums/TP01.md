...
Biological sequence data files are stored in databases with a unique number or **identifier** (also sometimes called "key") that identifies the sequence like a key in a dictionary. This identifier is essential forany database to keep sequences organized.
