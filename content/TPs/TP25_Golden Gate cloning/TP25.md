...
The DNA sequences of the two molecules shown below are available in the two files [Destination\_vector.gb](TPs/TP25_GoldenGateCloning/Destination_vector.gb) and [insert.gb](TPs/TP25_GoldenGateCloning/insert.gb).

Look at the figure below for a detailed overview of the process.

![](TPs/TP25_Golden Gate cloning/TP25_GoldenGateCloning_html_dc55f6fe.png)
...
Put your results in the indicated cells for forward primer (**fp**), reverse primer (**rp**). Put the sequence of the resulting PCR product in the **PCR product** cell. Put the resulting vector in the **pGG\_geneZ** column. Please answer with raw DNA sequences as indicated for the first example student "Max Maximus".
