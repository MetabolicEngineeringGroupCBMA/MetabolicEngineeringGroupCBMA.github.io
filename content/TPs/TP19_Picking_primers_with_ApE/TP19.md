...
Open the URA3\_locus.txt file in ApE. It contains a FASTA file or the URA3 locus of _Saccharomyces cerevisiae_. URA3 is an enzyme in the metabolic pathway for uracil synthesis.
...
The first primer will be 20 nt long, start at 64 and end at 83. What you have selected is a forward primer for the sequence. Copy the sequence for the primer to Notepad (_Bloco de notas_) or another text editor.
