## _**Primer design and melting temperature calculations for PCR primers**_
...
A, T, G and C  are the number of the respective bases in the sequence (modified from **Marmur**, J., and Doty, P. 1962 _J Mol Biol_ **5**:109-118).  According to this formula, the Tm for the primer below should be **42ºC**:
...
Please answer with raw DNA sequences as indicated for the first example student "_Max Maximus_".
