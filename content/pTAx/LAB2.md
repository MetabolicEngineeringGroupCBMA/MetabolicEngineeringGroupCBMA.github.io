...
4. Add 2 µL [[6x DNA loading buffer|6 x loading buffer]] to your plasmid DNA.
...
- 33 µL 1.66 x PCR mastermix (= [[2x PCR mastermix]] with [[6x DNA loading buffer|6x loading buffer]] , hhis is a green solution that has both PCR master mix and loading buffer)
