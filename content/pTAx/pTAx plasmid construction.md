...
![[pTAx plasmid construction.png|540x304]]
...
The pTAx vectors are made from **five** genetic elements using *in-vivo* homologous recombination between five PCR products (Table #2 ➀, ➁, ➂, ➃ and ➄).
...
| [[LAB3]]  |       |       | PL3   | Agarose gel II (PCR products), Inoculate *S. cerevisiae* culture.             |
