...
This extension is called dscode and allows unambiguous description of a double stranded DNA molecule
...
The dscode alphabet is a superset of the IUPAC alphabet. The symbols take on a different meaning as each symbol represent a basepair instead of a single base (a base in a DNA strand and its complementary base on the other strand. The alphabet uses an additional ten symbols to represent single stranded regions where there is no complementary base. See table below. The dsIUPAC remains 100% compatible with the IUPAC alphabet. [link](https://docs.google.com/document/d/1QAjGeCByWemjVZnva7ap3sg7e8wIwVUK4-pIjt4GIZ0/edit?usp=sharing)
...
The symbols PEXI and QFZJ thatare not occupied by the extended IUPAC alphabet were adopted to imply single stranded DNA.

The choice of symbols for the dscode extension facilitate intuitive recognition of compatible single stranded regions, i.e. sticky-ends.
